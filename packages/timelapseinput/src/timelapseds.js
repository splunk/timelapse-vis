                            ...
                            case 'cap':
                                {
                                    const updateUntilTime = ([time]) => {
                                        ...
                                        const fn = timelapse.transform === 'cap' ? capAt : nullAfter;
                                        observer.next({
                            ...
                            case 'select':
                                {
                                    ...
                                    onabortCallbacks.push(globalTime.subscribeToTimeSpan(selectNext));
                                }
                                break;
                            default:
                                throw new Error(`Invalid timelapse transform ${timelapse.transform}`);
                        }
                    }
                })
                .catch((e) => {
