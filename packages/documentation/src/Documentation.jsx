                        ...
                        <ColumnLayout gutter={8}>
                            <ColumnLayout.Row>
                                <ColumnLayout.Column span={6} style={colStyle}>
                                    ...
                                    <List type="decimal">
                                        <List.Item>
                                            demo (string, currently accepts boolean values)
                                        </List.Item>
                                    ...
                                    <Heading level={4}>
                                        ...
                                        &nbsp; &nbsp; &nbsp; Tips for Creating a Timelapse Dashboard
                                    </Heading>
                                    <P>
                                        In order to create a timelapse compatible dashboard, your
                                    ...
                                    <List type="decimal">
                                        <List.Item>
                                            <strong>
                                                ...
                                                for the users of your timelapse dashboard.
                                            </strong>
                                            &nbsp;For example, if you have a private dashboards it
                                            will not work for all users.
                                        </List.Item>
                                        <List.Item>
                                            <strong>
                                                All searches should have a valid _time field.
                                            </strong>
                                        </List.Item>
                                        <List.Item>
                                            <strong>
                                            ...
                                            <br />
                                            This can typically be completed by adding the following
                                            SPL to the end of your search:
                                            <br />
                                            <i>| sort 0 + _time</i>
                                        </List.Item>
                                        <List.Item>
                                            <strong>
                                                All searches should return all iterations of the
                                                data that will show-up in the timelapse.
                                            </strong>
                                            <br />
                                            For example a single value for a regular dashboard might
                                            ...
                                            <br />
                                            For a timelapse single value, you'll want the data to be
                                        ...
                                        <List.Item>
                                            <strong>
                                                For searches with multiple-dimensions, every _time
                                                should have values for all other dimmensions.
                                            </strong>
                                            <br />
                                            For example a timelapse compatible single value might be
                                            ...
                                            <br />
                                            <br />
                                            For something more complicated, like an SVG, you'll want
                                            to have all iterations sorted in ascending order by
                                            _time:
                                            <br />
                                            <table>
                                                <tbody>
