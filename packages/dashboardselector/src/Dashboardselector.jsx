            ...
            <ColumnLayout gutter={1} style={{ width: "100%" }}>
              {this.state.error_no_tz_set ? (
                <MessageBar type="warning" onRequestClose={() => {}}>
                  No timezone is set for the current user. Defaulting to GMT.
                  For best results, please set your TZ in User Preferences, and
                  ...
                  >
                    <Modal.Body>
                      ...
                      <List>
                        ...
                        <List>
                          <List.Item>
                            Specifies exactly what the start and end time will
                            be for the timelapse. Using this means that every
                            time the dashboard is loaded, the timelapse will use
                            the exact same start and end time.{" "}
                          </List.Item>
                        </List>
                        ...
                        <List>
                          <List.Item>
                            {" "}
                            Specifies a relative start and end time for the
                            timelapse. Using this will mean that every time the
                            dashboard is loaded, the timelapse will use a time
                            that is relative to the current time.{" "}
                          </List.Item>
                        </List>
                      </List>
                    </Modal.Body>
              ...
              <ColumnLayout.Row>
                <ColumnLayout.Column style={colStyle} span={1}>
                  <ListDashboards
                    changehandler={this.handleDashboardIdChange}
                  />
                </ColumnLayout.Column>
                <ColumnLayout.Column style={colStyle} span={1}>
